...
class TopicListScreen extends StatelessWidget {
  ...
  static const Map<String, List<String>> topics = {
    ...
    'physics': [
      ...
      'Chemical Equations - Chapter 2 (Types of reactions, Balancing, Effects of oxidation)',
      'Acids, Bases and Salts - Chapter 3 (pH Scale, Indicators, Salts from common salt)',
      'Refraction of Light at Curved Surfaces - Chapter 4 (Lenses, Lens maker\'s formula)',
      'The Human Eye and the Colourful World - Chapter 5 (Eye defects, Dispersion, Scattering of light)',
      'Structure of Atom - Chapter 6 (Spectrum, Quantum numbers, Electronic configuration)',
      'Classification of Elements - The Periodic Table - Chapter 7 (Periodic properties, Groups/Periods)',
      'Chemical Bonding - Chapter 8 (Ionic and Covalent bonding, VSEPR theory)',
      'Electric Current - Chapter 9 (Ohm\'s Law, Kirchhoff\'s Laws, Resistance in Series/Parallel)',
      'Electromagnetism - Chapter 10 (Magnetic field, Induction, Motor, Generator)',
      'Principles of Metallurgy - Chapter 11 (Extraction of metals, Corrosion, Purification)',
      'Carbon and its Compounds - Chapter 12 (Hybridization, Allotropes, IUPAC nomenclature)',
    ],
    'biology': [
